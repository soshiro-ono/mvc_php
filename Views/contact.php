    ...
    <div class="form-container">
      ...
      <form action="confirm.php" method="post" class="form-contact">
        <div class="form-contents">
          ...
          <div class="form-content">
            <input type="text" name="name" id="name" placeholder="山田太郎" value="<?php if (isset($_SESSION['name'])) {
              echo $_SESSION['name'];
            }
            ?>">
          ...
          <div class="form-content">
            <input type="text" name="kana" id="kana" placeholder="ヤマダタロウ" value="<?php if (isset($_SESSION['kana'])) {
              echo $_SESSION['kana'];
            }
            ?>">
          </div>
          ...
          <div class="form-content">
            <input type="text" name="tel" id="tel" placeholder="09012345678" maxlength="50" value="<?php if (isset($_SESSION['tel'])) {
              echo $_SESSION['tel'];
            }
            ?>">
          </div>
          ...
          <div class="form-content">
            <input type="text" name="email" id="email" placeholder="test@test.co.jp" maxlength="50" value="<?php if (isset($_SESSION['email'])) {
              echo $_SESSION['email'];
            }
            ?>">
          </div>
          ...
          <div class="form-content">
            <textarea name="body" id="body"  maxlength="500" wrap="hard" ><?php if (isset($_SESSION['body'])) {
              echo $_SESSION['body'];
            }
            ?></textarea>
          </div>
